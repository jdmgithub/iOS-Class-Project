...
//  Blob
//
//  Created by Jeffery Moulds on 6/3/14.
...
//        blob.physicsBody = [[SKPhysicsBody alloc] init];
...
//        blob.physicsBody.affectedByGravity = NO;
        ...
        SKSpriteNode * floor = [SKSpriteNode spriteNodeWithColor:[UIColor lightGrayColor] size:CGSizeMake(1024, 50)];
...
//        NSLog(@"X : %f y : %f w: %f h % f", hill1.position.x, hill1.position.y, hill1.size.width, hill1.size.height);
...
-(void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event {
    ...
    {
        [blob.physicsBody applyImpulse:CGVectorMake(0.0, 100.0)];
